...
const bookingSchema = new mongoose.Schema({
  ...
  roomSelection: {
    ...
    acStatus: {type: Number, enum: [0, 1], default: null}, // 0: Non-AC, 1: AC, null: Both
    rooms: [{
  ...
  // Prices Section
  prices: {
    villaPrice: {type: Number, required: true, default: 0},
    roomPrices: [{
  ...
  customer: {
    ...
    passengers: {
      adults: {type: Number, required: true, default: 0, min: 0},
      children: {type: Number, required: true, default: 0, min: 0}
    }
  },
