    ...
    <div>
      ...
      {!scanning && !scannedData && !loading && (
        <div className="text-center">
          ...
          <div className="max-w-xl mx-auto mt-8 p-4 bg-blue-50 rounded-lg border border-blue-100">
      ...
      {scanning && (
        <div className="space-y-4">
          <div className="relative max-w-2xl mx-auto rounded-xl overflow-hidden shadow-lg">
            <Scanner
              onScan={handleScan}
              onError={handleError}
      ...
      {error && !loading && (
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-2">Scanning Failed</h3>
