...
import { CheckCircle, Calendar, Home, Users, Building2, Loader } from 'lucide-react';
      ...
      <div className="max-h-[80vh] overflow-y-auto">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600">
            Review your booking details below to continue with signup.
          </p>
        </div>
          ...
          <>
            ...
            <div className="mb-6 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <div className="text-xs text-gray-600 mt-2 flex gap-3">
                ...
                <span>
                  Payment: <span className="capitalize font-medium text-gray-800">{bookingDetails.paymentStatus}</span>
                </span>
              </div>
            </div>
