  ...
  return (
    <Modal isVisible={isVisible} onClose={onClose} width="max-w-3xl w-full">
      <div className="flex flex-col max-h-[80vh]">
        {/* Scrollable content */}
        <div className="overflow-y-auto px-0 py-4 flex-1">
          {/* Validation Error Display (moved to QRErrors component) */}
          <QRErrors
        ...
        {/* Sticky action footer (stable, won't scroll) */}
        <div className="border-t border-gray-200 bg-white px-6 py-4 flex-shrink-0">
          <div className="max-w-3xl mx-auto flex gap-3">
            ...
            <button
              ...
              className="flex-1 bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Continue to Signup
            </button>
          </div>
